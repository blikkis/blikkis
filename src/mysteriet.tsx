      ...
      {tab === "info" && (
        <main className="mysteriet__content">
          ...
          <section className="mysteriet__section">
            ...
            <p>To personer vil snart få beskjed om at de er morderne. Resten vil være de uskyldige på reisen. Hva er det morderne gjør? Først og fremst må de skaffe seg et våpen, og ha en måte å tydelig bruke det våpenet. Eksempler kan være at de har en vannpistol og sier "pang pang" eller at de har en tryllestav og sier "Avada kadavra" og "du er død". Dette kan kun skje når morderen er helt alene med en av de uskyldige reisende - for om det er et vitne til drapet, så kan de sladre. Simen var det uheldige første offeret, og har gjenoppstått som gjenferd og game master. Det er denne personen et vitne kan sladre til, som vil føre til at Simen tar sin hevn på morderen, og morderen selv dør. Alt må selvfølgelig skje i person. Morderne må fortelle Simen når de har drept noen. De kan riske å gjøre dette på slack (da er det en sjanse for at noen ser på mobilen til Simen akkurat da), så helst gjør det i hemmelighet i person. Om du dør, så har du ikke lov til å si rollen din eller hvem som drepte deg selvfølgelig. SPILLET STARTER TORSDAG MORGEN KLOKKEN 0800. DERE KAN SJEKKE ROLLER FØR DET</p>
          </section>
